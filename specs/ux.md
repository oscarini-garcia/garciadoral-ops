...
**Y bajo el saludo, la frase del día**, que es lo único de la aplicación que no sirve para nada. Dos líneas con guasa sobre lo que hay apuntado —o sobre no haber nada, que es lo más frecuente—, escritas por el modelo, una al día y guardadas en el teléfono: pedirla en cada apertura la cambiaría al volver de la pestaña de al lado y dejaría de ser la frase *del día*. Se toca y pasa a la siguiente. **Vienen de cinco en cinco y se enseñan de una en una**, que cuesta lo mismo que pedir una —lo que se paga es el encargo y el material— y hace que el toque conteste en el acto en vez de esperar a un modelo; solo al gastar las cinco se pide otra tanda, diciéndole cuáles ha escrito ya. De paso le salen mejor: pidiendo cinco a la vez las escribe distintas entre sí, mientras que cinco peticiones seguidas con el mismo material daban cinco versiones del mismo chiste. Va en cursiva y en serifa porque es una voz y no un dato, y sin caja, sin rótulo y sin icono: una broma dentro de un recuadro con borde pide que la tomes en serio. Su sitio es detrás de lo que espera respuesta y delante de todo lo demás —una broma por encima de lo único que aguarda a alguien es una broma a destiempo, y los días con peticiones son los menos—. Sin clave de Anthropic puesta no hay línea, ni hueco, ni disculpa. El tono se le marca a mano —ironía seca, insinuar en vez de decir, y prohibidos los tacos y las exclamaciones—, porque sin decírselo no lo acierta: la primera tanda de verdad trajo un taco puesto para dar énfasis, que es justo lo que hace una frase cuando no confía en su propia gracia. Y la única regla suya que no es de estilo: **el encargo le prohíbe nombrar regalos, ideas y deseos**, aunque el material nunca se los dé, porque esta es la pantalla que se lee con alguien al lado. El porqué de cada decisión está en `specs/propuesta-frase-del-dia.html`.

**Y Lío tiene voz propia**, dentro de su bloque: una frase suya bajo el rótulo y encima de sus turnos, en primera persona —digno, algo ofendido, irónico—, compuesta de lo que de él se sabe: de quién son los turnos de hoy, cuáles quedaron sin marcar y cuántos días seguidos ha salido. Va **dentro del grupo y no encima** porque es de Lío y no de la pantalla: fuera del rótulo sería otra frase del día, y ya hay una. La idea viene de `lio-ops`, la aplicación del perro que se quedó en inspiración: allí Lío tenía siete frases fijas y era lo mejor que tenía; aquí hay de dónde sacarlas, porque los turnos son datos. Se le prohíbe reñir de verdad —quien lo lee es casi siempre quien no marcó, y lo lee desayunando— y inventar quién lo sacó, que sería una acusación falsa delante de toda la casa.
...
**Una pregunta tiene dos respuestas.** La pantalla pregunta «¿sacaste a Lío?» y durante un tiempo solo admitía que sí: quien no lo hubiera sacado no tenía manera de decirlo, y el turno se quedaba para siempre en «nadie marcó», que no es lo mismo. **Sin marcar es no saberlo; no haber salido es saber que no.** En la fila de Hoy son dos casillas del mismo tamaño —el visto y el aspa—, porque son las dos contestaciones a lo mismo y tienen que pesar igual; en la hoja del turno, «Sí, lo saqué» y «No salió». **Solo sobre el turno propio**: decir que otro no sacó al perro es una afirmación sobre lo que hizo otro, y eso, como la corrección, no se escribe de un toque. Contestado que no, el turno se resuelve y deja de subir a Hoy; deshacerlo se hace desde su hoja.
...
**Lo que se cambia en Ajustes vale de ahora en adelante.** El reparto no es un ajuste sino el turno que estuvo en vigor durante un tiempo, así que guardar no pisa el que había: añade uno nuevo que empieza en ese instante, y cada turno se deriva del que gobernaba **cuando se abrió su ventana**. Editar a las seis de la tarde cambia el de noche y deja intacto el de la mañana, sin inventar ninguna frontera: es la misma que ya decide cuándo un turno pasa a estar sin marcar. Antes había un solo cuadro, y con él un martes pasado que nadie marcó cambiaba de dueño al tocar Ajustes; la pantalla lo dice ahora con todas sus letras debajo del cuadro. El porqué y las tres alternativas descartadas están en `specs/propuesta-cuadro-con-vigencia.html`.
...
**El sitio es la carpeta y los apuntes cuelgan de él**, en dos alturas dentro de la misma pestaña. La navegación entre las dos vive en la línea del título, en forma de migas —**«Sitios › Bolonia»**, con «Sitios» tocable—, y no en un «‹ Sitios» debajo: dónde estás y de dónde vienes se leen juntos o no se leen. El sitio se queda con el tamaño del título y «Sitios» va pequeño y en tinta, que es lo que hace que se lea como un camino y no como dos rótulos peleándose por la misma línea.

**En la lista, cada sitio dice de qué va y no cuánto tiene**: «3 llevar · 2 hacer · 1 ir», y los verbos sin nada no salen. «6 apuntes» no contestaba nada —seis puede ser una lista de la compra o seis playas— y la pregunta que se hace al recorrer la lista es de qué va cada sitio.

**El emoji de un sitio se escribe con su selector de variación.** Hay un puñado —🏖, 🏝, ⛺— que Unicode define con presentación de texto por defecto, y sin el selector el sistema los dibuja como un glifo monocromo a trazo: en un título de 29 puntos en serifa, un icono roto. No faltaba el emoji, se dibujaba en blanco y negro. Es la única forma en la que la pantalla de entrada sigue siendo legible dentro de tres años —los sitios son cinco o seis para siempre y los apuntes se multiplican— y la que le da al voto y al comentario una cosa pequeña de la que colgar.

**El campo sigue siendo uno solo —«para otro emoji, empieza el título con él»—, y el redondel de al lado no es un segundo campo.** Es una vista previa que refleja en vivo lo que se va a separar al guardar, vacía de verdad hasta que hay algo: dos campos con un emoji de ejemplo dentro ya se probaron y se quitaron, porque un marcador con emoji se ve exactamente igual que un valor puesto. Lleva un destello en su esquina, el mismo botón que ya usa Regalos para pedirle un «Qué» a la IA: pide cinco emojis a partir del nombre que se lleva escrito, con el mismo carrusel de siempre —una propuesta a la vez, «Ponerlo» la pasa al campo—. No es uno de los seis encargos: no tiene instrucción propia editable en Ajustes, porque no hay casi nada que decidir en una frase que pide un emoji.

**Cuatro clases, y las cuatro son verbos: Llevar, Hacer, Ir y Saber.** Verbos porque es como se dicen en voz alta, y porque así «Sitios» puede ser el nombre de la pestaña sin chocar con «sitios donde ir». «Saber» es el cuarto verbo y no un cajón de sastre: nombra un contenido concreto —el súper cierra a las dos, el aparcamiento se llena a las once— en lugar de nombrar la ausencia de los otros tres, que es lo que hace que un «Otros» se trague la mitad de las filas en dos veranos. Va en el orden del viaje —se prepara, se planea, se llega— con Saber al final, porque es lo que se consulta y no lo que se recorre, y **es la que va puesta de origen**: quien no quiera clasificar no tiene que hacerlo. La clase se elige con las mismas pastillas con las que se elige gente, y por la misma razón: cuatro palabras cortas y excluyentes caben a la vista, y un desplegable cuesta dos toques y una lista para elegir entre ellas.

**Y «Llevar» no es una clase más: es una lista de la compra.** Va la primera porque es lo único de un sitio que se mira **con prisa**, de pie y antes de salir por la puerta, y por eso se dibuja distinto de las otras tres: una línea, una casilla y un aspa. Sin descripción, sin voto y sin hilo. **La casilla y el texto son dos blancos separados.** Tocar la casilla tacha —sigue siendo pequeña, el toque le crece por pseudoelemento sin tocar el dibujo—, y lo tachado se queda tachado y **baja al final**, de modo que lo que falta queda arriba y al volver del viaje se desmarca y la lista sirve otra vez. Tocar el texto lo sustituye por un campo con lo mismo puesto: Intro o perder el foco confirma, Escape lo deja como estaba. Antes era un único blanco para toda la línea y no se editaba —«corregir una errata es volver a escribirla»—, pero eso cargaba cada errata con borrar y reescribir; separar los dos blancos permite las dos cosas sin que ninguna le quite terreno a la otra.

**Cada línea de esa lista lleva su firma**: quién la puso y, **solo si ya no es de hoy**, cuándo. «(Marta)» recién escrito y «(Marta, el martes)» pasados unos días, en gris suave y detrás del texto. El cuándo aparece cuando aporta: recién apuntado el nombre basta, y saber que algo lleva ahí desde el martes es la mitad de lo que se quiere saber. Si el título es largo, lo que se recorta es el título y la firma se queda entera: es lo más corto de los dos y lo que peor se adivina.

**Y la lista se comparte sola**, con su propio verbo dentro de la cabecera del apartado y no en una fila aparte del cuerpo —eso dejaba un botón huérfano en su propio renglón en cuanto no había nada más que decir ahí—. «Mándame lo que hay que llevar» se pide entero y sin lo demás; quien lo recibe no quiere saber a qué duna se sube ni qué súper cierra los domingos.

**Cada grupo es un apartado plegable con su propia cabecera de color**: una franja con fondo propio hace de marco de la sección, así que no lleva raya arriba ni abajo —ahí sobrarían, es la propia franja la que dice dónde empieza y dónde acaba—. Dentro de la franja, el ángulo de plegar va el primero, no el último: nada lo acompaña por la izquierda y necesita peso propio, y es un triángulo relleno en vez del trazo fino que usa Ajustes, que a este tamaño se lee peor estando solo. El nombre y el recuento van juntos —«Llevar · 2»—, con el punto la misma marca que ya separa `MA·OS` en un voto o «quién · cuándo» en una firma, no una figura nueva; y el verbo de compartir, si lo hay, al otro extremo. Se toca la franja entera, no solo el ángulo. **El estado se recuerda por aparato**, no por sesión ni en el registro: es una preferencia de pantalla, la misma familia que el tema, así que cambiar de persona en el mismo teléfono no despliega nada por sorpresa. Plegar un grupo no esconde su fila de escribir, que se queda fuera del apartado: se puede seguir metiendo cosas a un grupo sin desplegarlo antes. **Los grupos vacíos no se dibujan**: son cuatro grupos de cinco líneas, y uno sin nada no gana ni una cabecera ni una preferencia que recordar.

**Dentro de la sección no hay raya bajo cada fila, solo un hilo tenue entre una fila y la siguiente** —la mitad de fuerte que `--line`, ni antes de la primera ni después de la última— **y entre una sección y la siguiente hay más aire que antes**, al revés que el resto de la aplicación: aquí lo apretado es dentro y lo holgado es entre secciones. Nació de una queja de verdad —cuatro cabeceras de 44 puntos y una raya por fila, con dos o tres clases ya escritas, pesaban más de lo que cualquier número por separado explicaba—. `specs/prototipo-sitios-secciones-compactas.html` tiene las seis formas que se compararon para resolverlo y `specs/prototipo-sitios-cabecera-de-seccion.html`, los números finos de la cabecera y el ritmo.

**Dentro de un sitio no hay botón flotante: cada grupo lleva su propia fila de escribir al final**, y es la siguiente línea en blanco de la lista y no un formulario aparte: mismo molde que `.apunte` y `.llevar` —contenido a la izquierda, verbos a la derecha—, sin caja propia, con el mismo hilo tenue que separa las filas de encima. Es lo que sustituye al «+» de dentro —meter cosas rápido es escribir esa línea, y refinarlas es para después—, y por eso el flotante desaparece en esta altura y solo sigue creando sitios en la lista. En Llevar la fila no lleva más que el título y confirmarlo —y el «+» solo aparece con algo escrito, para no enseñar un verbo que todavía no hace nada—, porque una lista de la compra no tiene detalle que asociarle; en las demás clases lleva además un lápiz, siempre ahí, que entrega lo ya escrito, sin perderlo, a la misma hoja de siempre —con la clase puesta—, que es donde se describe, se pide una idea a la IA o se guarda tal cual. **Y el tamaño de letra no baja de 16 puntos**, la misma regla que ya tiene `.campo`: por debajo de eso Safari hace zoom al enfocar, y ese zoom es lo que arrastraba a la pantalla entera con él. En Llevar, el texto de la fila empieza donde empieza el título de la línea de encima y no donde empezaría su casilla —esta fila no lleva una—, para que la lista siga leyéndose en una sola columna. Las clases que todavía no tienen nada no rompen la regla de los grupos vacíos: se enseñan como una píldora de borde discontinuo —«+ Ir»—, **al final de lo que ya hay apuntado y no delante**, para que un sitio con contenido lo enseñe primero; tocarla es lo único que abre un grupo sin apuntes todavía, con su fila de escribir ya enfocada.
...
**Lo de Lío atraviesa el modo concentración; lo demás, no.** Es la única distinción de urgencia que se hace, y se hace porque el caso que justifica todo este módulo es exactamente ese: una petición de turno para esta mañana que llega a mediodía no es un aviso, es un reproche. Quedan fuera las correcciones, que hablan del pasado por definición y a las que llegar tarde no les quita nada. La tentación es marcarlo todo de urgente, y se paga en el mismo sitio: quien recibe dos avisos así que no lo eran deja de fiarse del tercero.

**El globo del icono cuenta lo que espera respuesta, y solo eso.** No es «cuántas novedades hay»: un comentario nuevo no reclama nada de nadie, y un número que solo baja abriendo la aplicación acaba siendo un número que no se mira. Cuenta lo mismo que el grupo de arriba del sobre —lo que se contesta o se queda— y por eso no contradice que el sobre no lleve cifra: el sobre dice *que hay algo* y el globo dice *que alguien espera*. Va en todos los avisos aunque no sean de Lío, porque el número es absoluto: uno que llegara sin él dejaría puesta la cuenta anterior. Y lo escribe también la aplicación en cada refresco, porque contestar desde dentro no genera ningún aviso y sin eso el globo se quedaría contando lo que ya no espera.
