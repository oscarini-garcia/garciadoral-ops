...
**Y «Llevar» no es una clase más: es una lista de la compra.** Va la primera porque es lo único de un sitio que se mira **con prisa**, de pie y antes de salir por la puerta, y por eso se dibuja distinto de las otras tres: una línea, una casilla y un aspa. Sin descripción, sin voto y sin hilo. Tocar la línea entera la tacha —es el gesto que se repite doce veces seguidas y no puede pedir puntería—, y lo tachado se queda tachado y **baja al final**, de modo que lo que falta queda arriba y al volver del viaje se desmarca y la lista sirve otra vez. No se edita: el formulario es un solo campo, así que corregir una errata es volver a escribirla, y un verbo de editar ahí pesaría más que el error.
