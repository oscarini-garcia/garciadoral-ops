...
**El sol y la luna solo viven en el carril.** Ahí una pastilla mide 38 puntos y no cabe una frase, así que el turno se dibuja. En todo lo demás —la hoja del turno, las filas de Hoy, el cuadro de Ajustes, el aviso del teléfono— se escribe **«Por la mañana»** y **«Por la noche»**: un emoji al lado de su propio nombre no añadía nada, y un emoji en lugar del nombre obliga a traducirlo cada vez.
...
**Toda hoja de Lío se puede abandonar, y siempre por el mismo sitio.** «Cancelar» va **al final y a la derecha**, en su propio renglón y detrás de todo lo demás, que es donde ya estaba en el formulario de evento. Compartiendo línea con el verbo, y con el selector de relevo debajo, parecía el final de algo que aún seguía; abajo del todo es donde se acaba de leer y donde el pulgar ya está. Son pantallas que cambian de dueño un turno o dejan escrito que el perro salió, y salir sin hacer nada tiene que ser tan fácil como hacerlo.
