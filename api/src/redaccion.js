...
export const INSTRUCCION_CHISPA_POR_DEFECTO = [
  ...
  'Escribe CINCO frases distintas entre sí, de dos o tres líneas cada una, en',
  'español de España y tuteando. Hay sitio para la tercera, pero que la frase la',
  'pida y no la rellene: una que cabía en dos y ocupa tres se nota.',
  'El tono es la ironía seca: la gracia está en lo que insinúas y no en lo que',
  'dices, y en decirlo con calma. No expliques el chiste ni lo remates, y da por',
  'sabido lo que quien lee ya sabe.',
